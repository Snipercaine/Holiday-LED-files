...
#define wifi_password "yourwifipasswoed" //enter your WIFI Password

#define mqtt_server "you.mqtt.HA.pi" // Enter your MQTT server adderss or IP. I use my DuckDNS adddress (yourname.duckdns.org) in this field
...
#define COLOR_ORDER GRB //change to match your LED configuration - ws2812 are GRB, ws2811 are RGB
#define NUM_LEDS    200 //change to match your setup - if you have more than one run of lights, set this to the number of LEDs in the run with the most.
...
////////////////Add setup__Palette here for Candy Cane-like animation with custom colors//////////////////
  setupStripedPalette( CRGB::Red, CRGB::Red, CRGB::White, CRGB::White); //for CANDY CANE
  setupThxPalette( CRGB::Sienna, CRGB::Sienna, CRGB::FireBrick, CRGB::FireBrick); //for Thanksgiving
  setupHailPalette( CRGB::Blue, CRGB::Blue, CRGB::Yellow, CRGB::Yellow); //for HAIL
  setupHalloweenPalette( CRGB::Orange, CRGB::Orange, CRGB::Purple, CRGB::Purple); //for Halloween
  setupHJPalette( CRGB::Red, CRGB::Red, CRGB::Green, CRGB::Green); //for Holly Jolly
  setupIndPalette( CRGB::Red, CRGB::White, CRGB::Blue, CRGB::White); //for Independence
...
///////////////////////////////////////
  ...
  if (setEffect == "Thanksgiving") {                                  // colored stripes pulsing in Shades of BROWN and ORANGE 
  ...
  if (setEffect == "Punkin") {
    ...
    int thathue = (thishueLovey + 32) % 255;
