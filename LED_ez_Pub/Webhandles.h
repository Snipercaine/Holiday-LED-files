...
void Webhandlecolour()
{
  ...
  httpMessage += String("<label>Brighness:</label><br/> <input type='range' min='1' max='255' value='" + String(brightness) + "' class='slider' name='brightness'/>");
...
//    MQTTclient.publish(setpowerPubTopic, "OFF");
  ...
  httpMessage += String("<input type='range' min='1' max='255' value='" + Bright  + "' name='Brightness' class='slider' id='Brightnes'/>");
  httpMessage += String(F("<label>Speed</label>"));
  httpMessage += String("<input type='range' min='1' max='240' value='" + Speed  + "' class='slider'name='Speed'  id='Speed'/>");
