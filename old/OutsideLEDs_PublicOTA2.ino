...
#define wifi_password "yourpw" //enter your WIFI Password
...
#define mqtt_server "yourmqttip" // Enter your MQTT server adderss or IP. I use my DuckDNS adddress (yourname.duckdns.org) in this field
#define mqtt_user "yourusername" //enter your MQTT username
#define mqtt_password "yourpw" //enter your password
